<div class="topbar">
                ...
                <div class="topbar-left">
                    <a href="{{url('/dashboard')}}" class="logo">
                        <img src="{{asset('backend/assets/images/logo.png')}}" alt="" height="20" class="logo-large">
                        <img src="{{asset('backend/assets/images/logo-sm.png')}}" alt="" height="22" class="logo-sm">
                    </a>
                </div>
                    ...
                    <ul class="navbar-right d-flex list-inline float-right mb-0">
                        <li class="list-inline-item dropdown notification-list flags-dropdown d-none d-sm-inline-block">
                            ...
                            aria-haspopup="false" aria-expanded="false">
                                <img src="{{asset('backend/assets/images/flags/us_flag.jpg')}}" alt="" class="flag-img">
                                United States <i class="mdi mdi-chevron-down"></i>
                            </a>
                            <div class="dropdown-menu dropdown-menu-animated">
                                <a href="#" class="dropdown-item"><img src="{{asset('backend/assets/images/flags/french_flag.jpg')}}" alt="" class="flag-img"> French</a>
                                <a href="#" class="dropdown-item"><img src="{{asset('backend/assets/images/flags/germany_flag.jpg')}}" alt="" class="flag-img"> Germany</a>
                                <a href="#" class="dropdown-item"><img src="{{asset('backend/assets/images/flags/italy_flag.jpg')}}" alt="" class="flag-img"> Italy</a>
                                <a href="#" class="dropdown-item"><img src="{{asset('backend/assets/images/flags/spain_flag.jpg')}}" alt="" class="flag-img"> Spain</a>
                            </div>
                        </li>
